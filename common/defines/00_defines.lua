...
NGame = {
    -- Modified_CWIC
	START_DATE = "1945.5.23.12",                    -- CWIC Vanilla "1936.1.1.12"->"1945.5.23.12"
	END_DATE = "2050.5.23.12",                      -- CWIC Vanilla "1949.1.1.1"->"2050.5.23.12"
	...
	LAG_DAYS_FOR_LOWER_SPEED = 100,					-- CWIC Vanilla 10->100, Days of client lag for decrease of gamespeed
	LAG_DAYS_FOR_PAUSE = 50,						-- CWIC Vanilla 25->50, Days of client lag for pause of gamespeed.
...
NDiplomacy = {
	...
	MAX_OPINION_VALUE = 200,						-- CWIC Vanilla 100->200, Max opinion value cap.
	MIN_OPINION_VALUE = -200,						-- CWIC Vanilla -100->-200, Min opinion value cap.
	...
	BASE_PEACE_TAKE_UNCONTROLLED_STATE_FACTOR = 10.0, -- CWIC Vanilla no modified, Base factor for taking state you do not control
...
-- In peace conference, cost is factored based on how many times the state has been contested and for how long it has been uncontested (for everyone else)
	...
	VOLUNTEERS_PER_TARGET_PROVINCE = 0.05,			-- CWIC Vanilla no modified, Each province owned by the target country contributes this amount of volunteers to the limit.
	VOLUNTEERS_PER_COUNTRY_ARMY = 0.05,				-- CWIC Vanilla no modified, Each army unit owned by the source country contributes this amount of volunteers to the limit.
	VOLUNTEERS_RETURN_EQUIPMENT = 0.95,				-- Returning volunteers keep this much equipment
	VOLUNTEERS_TRANSFER_SPEED = 21,					-- CWIC Vanilla 14->21, days to transfer a unit to another nation
	VOLUNTEERS_DIVISIONS_REQUIRED = 1,				-- CWIC Vanilla 30->1, This many divisons are required for the country to be able to send volunteers.
	TENSION_STATE_VALUE = 5,						-- CWIC Vanilla 2->5, Tension value gained by annexing one state
	TENSION_CIVIL_WAR_IMPACT = 0.2,					-- civil war multiplier on tension.
	TENSION_NO_CB_WAR = 15,							-- CWIC Vanilla no modified, Amount of tension generated by a no-CB wargoal
	TENSION_CB_WAR = 5,								-- CWIC Vanilla no modified, Amount of tension generated by a war with a CB
	TENSION_ANNEX_NO_CLAIM = 2,						-- Amount of tension generated by annexing a state you don't have claims on
	TENSION_ANNEX_CLAIM = 1.5,						-- CWIC Vanilla 1->1.5, Amount of tension generated by annexing a state you DO have claims on
	TENSION_ANNEX_CORE = 1,							-- CWIC Vanilla 0.5->1, Amount of tension generated by annexing a state that is your core
	...
	TENSION_DECAY = 0.1,							-- CWIC Vanilla no modified, Each months tension decays this much
	TENSION_SIZE_FACTOR = 0.25,						-- CWIC Vanilla 1.0->0.25, All action tension values are multiplied by this value
	TENSION_TIME_SCALE_START_DATE = "1999.1.1.12",	-- CWIC Vanilla "1936.1.1.12"->"1999.1.1.12", Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
	TENSION_TIME_SCALE_MONTHLY_FACTOR = 0,			-- CWIC Vanilla -0.005->0, Timed tension scale will be modified by this amount starting with TENSION_TIME_SCALE_START_DATE
	TENSION_TIME_SCALE_MIN = 0.25,					-- CWIC Vanilla 0.25->0.0, Timed tension scale won't decrease under this value
	TENSION_GUARANTEE = 0,                          -- CWIC Vanilla -5->0
	TENSION_FACTION_JOIN = 4,
	TENSION_JOIN_ATTACKER = 2,						-- scale of the amount of tension added when country joins attacker side
	TENSION_PEACE_FACTOR = 0.0,						-- CWIC Vanilla 0.25->0.0, scale of the amount of tension (from war declaration) reduced when peace is completed.
	TENSION_LIBERATE = 0,							-- CWIC Vanilla -1->0, Amount of tension generated by liberating a country.
	TENSION_CAPITULATE = 1.0,						-- CWIC Vanilla 0.75->1.0, Scale of the amount of tension created by a countries capitulation.
	...
	IDEOLOGY_JOIN_FACTION_MIN_LEVEL = 0.0,			-- CWIC Vanilla 0.3->0, ideology limit required to join faction
...
NCountry = {
	EVENT_PROCESS_OFFSET = 20,						-- CWIC Vanilla no modified, Events are checked every X day per country or state (1 is ideal, but CPU heavy)
	BASE_RESEARCH_SLOTS = 2,						-- Base number of research slots per country.
	POPULATION_YEARLY_GROWTH_BASE = 0.008,			-- CWIC Vanilla 0.015->0.008, basic population growth per year, used for monthly manpower gain
	...
	ARMY_SCORE_MULTIPLIER = 2.0,					-- CWIC Vanilla 0.15->2.0, Based on number of armies.
	NAVY_SCORE_MULTIPLIER = 25.0,					-- CWIC Vanilla 1.0->25.0, Based on number of navies.
	AIR_SCORE_MULTIPLIER = 0.01,					-- CWIC Vanilla 0.1->0.01, Based on number of planes (which is typically a lot).
	INDUSTRY_SCORE_MULTIPLIER = 1.0,				-- CWIC Vanilla no modified, Based on number of factories.
	PROVINCE_SCORE_MULTIPLIER = 0.1,				-- CWIC Vanilla no modified, Based on number of controlled provinces.
	...
	MIN_COUP_SUCCESS_STABILITY = -2,				-- CWIC Vanilla 0.8->-2, Max stability when coup will happen
	...
	-- Modified
	POLITICAL_POWER_LOWER_CAP = -2500.0,			-- -500->-2500, Min amount of political power country should have
	POLITICAL_POWER_UPPER_CAP = 5000.0,				-- 2000.0->5000.0, Max amount of political power country should have
	...
	CIVIL_WAR_INVOLVEMENT_MIN_TENSION = 0.0,		-- CWIC Vanilla 0.5->0.0, base value of world tension to involve other sides to the civil war
	...
	AIR_VOLUNTEER_PLANES_LIMIT = 0.5,				-- CWIC Vanilla 0.2->0.5, Ratio for volunteer planes available for sending in relation to sender air force
	AIR_VOLUNTEER_BASES_CAPACITY_LIMIT = 0.5,		-- CWIC Vanilla 0.1->0.5, Ratio for volunteer planes available for sending in relation to receiver air base capacity
	...
	BASE_FUEL_GAIN_PER_OIL = 4,						-- CWIC Vanilla 2->4, base amount of fuel gained hourly per excess oil
...
NProduction = {
	MAX_EQUIPMENT_RESOURCES_NEED = 4, 	-- CWIC Vanilla 3->4, Max number of different strategic resources an equipment can be dependent on.
	MAX_CIV_FACTORIES_PER_LINE = 10,	-- CWIC Vanilla 15->10, Max number of factories that can be assigned a single production line.
	...
	BASE_FACTORY_SPEED_NAV = 2.5, 				-- CWIC Vanilla no modified, Base factory speed multiplier (how much hoi3 style IC each factory gives).
	...
	INFRA_MAX_CONSTRUCTION_COST_EFFECT = 0.7, 		-- CWIC Vanilla 1->0.7, Building in a state with higher infrastructure will reduce the cost of shared buildings.
	...
	EQUIPMENT_MODULE_ADD_XP_COST = 2.0,					-- CWIC Vanilla 5.0->2.0, XP cost for adding a new equipment module in an empty slot when creating an equipment variant.
	EQUIPMENT_MODULE_REPLACE_XP_COST = 2.0,				-- CWIC Vanilla 6.0->2.0, XP cost for replacing one equipment module with an unrelated module when creating an equipment variant.
	...
	EQUIPMENT_MODULE_REMOVE_XP_COST = 2.0,				-- CWIC Vanilla 1.0->2.0, XP cost for removing an equipment module and leaving the slot empty when creating an equipment variant.
...
NTechnology = {
	...
	BASE_RESEARCH_POINTS_SAVED = 50.0,		-- CWIC Vanilla 30.0->50.0, Base amount of research points a country can save per slot.
	BASE_YEAR_AHEAD_PENALTY_FACTOR = 1,		-- CWIC Vanilla 2->1, Base year ahead penalty
	BASE_TECH_COST = 100,					-- CWIC Vanilla no modified, Base cost for a tech. multiplied with tech cost and ahead of time penalties
	MAX_TECH_SHARING_BONUS = 0.15, 			-- CWIC Vanilla 0.5->0.15, Max technology sharing bonus that can be applied instantly
...
NPolitics = {
	...
	BASE_POLITICAL_POWER_INCREASE = 2,	-- CWIC Vanilla no modified, Weekly increase of PP.
...
NBuildings = {
	ANTI_AIR_SUPERIORITY_MULT = 100.0,	-- CWIC Vanilla 5.0->100.0, How much air superiority reduction to the enemy does our AA guns? Normally each building level = -1 reduction. With this multiplier.
	MAX_BUILDING_LEVELS = 200,			-- CWIC Vanilla 15->200, Max levels a building can have.
	AIRBASE_CAPACITY_MULT = 50,		    -- CWIC Vanilla 200->50, Each level of airbase building multiplied by this, gives capacity (max operational value). Value is int. 1 for each airplane.
	ROCKETSITE_CAPACITY_MULT = 0,		-- CWIC Vanilla May modified it to 0, 100->0, Each level of rocketsite building multiplied by this, gives capacity (max operational value). Value is int. 1 for each rocket.
	...
	RADAR_RANGE_MAX = 400,				-- CWIC Vanilla 200->400, Range is interpolated between building levels 1-15.
	...
	SUPPLY_PORT_LEVEL_THROUGHPUT = 5,   -- CWIC Vanilla 3->5, supply throughput per level of naval base
	-- Modified
	MAX_SHARED_SLOTS = 160,				-- 25->102->160,in CWIC Vanilla MAX_SHARED_SLOTS is 42. Max slots shared by factories
	...
	INFRASTRUCTURE_RESOURCE_BONUS = 0.0, -- CWIC Vanilla 0.2->0.0, multiplicative resource bonus for each level of (non damaged) infrastructure
	SUPPLY_ROUTE_RESOURCE_BONUS = 0.0,   -- CWIC Vanilla 0.2->0.0, multiplicative resource bonus for having a railway/naval connection to the capital
...
NMilitary = {
	...
	CORPS_COMMANDER_ARMIES_CAP = -1,			-- CWIC Vanilla no modified, how many armies a corps commander is limited to. 0 = inf, < 0 = blocked
	FIELD_MARSHAL_DIVISIONS_CAP = 0,			-- CWIC Vanilla 24->0, how many divisions a field marshall is limited to. 0 = inf, < 0 = blocked
	...
	MAX_DIVISION_SUPPORT_WIDTH = 2,			-- CWIC Vanilla 1->2, Max width of support in division designer.
	MAX_DIVISION_SUPPORT_HEIGHT = 5,		-- CWIC Vanilla no modified, Max height of support in division designer.

	BASE_DIVISION_BRIGADE_GROUP_COST = 3, 	-- CWIC Vanilla 20->3, Base cost to unlock a regiment slot,
	BASE_DIVISION_BRIGADE_CHANGE_COST = 3,	-- CWIC Vanilla 5->3, Base cost to change a regiment column.
	BASE_DIVISION_SUPPORT_SLOT_COST = 1, 	-- CWIC Vanilla 10->1, Base cost to unlock a support slot

	MAX_ARMY_EXPERIENCE = 5000,			-- CWIC Vanilla 500->5000, Max army experience a country can store
	MAX_NAVY_EXPERIENCE = 5000,			-- CWIC Vanilla 500->5000, Max navy experience a country can store
	MAX_AIR_EXPERIENCE = 5000,			-- CWIC Vanilla 500->5000, Max air experience a country can store
	...
	LAND_COMBAT_STR_DAMAGE_MODIFIER = 0.025,       -- CWIC Vanilla 0.060->0.025, global damage modifier... but some equipment is returned at end of battles see : EQUIPMENT_COMBAT_LOSS_FACTOR
	LAND_COMBAT_ORG_DAMAGE_MODIFIER = 0.025,       -- CWIC Vanilla 0.053->0.025, global damage modifier
	LAND_AIR_COMBAT_STR_DAMAGE_MODIFIER = 0.08,    -- CWIC Vanilla 0.032->0.08, air global damage modifier
	LAND_AIR_COMBAT_ORG_DAMAGE_MODIFIER = 0.12,    -- CWIC Vanilla 0.032->0.12, global damage modifier
	LAND_AIR_COMBAT_MAX_PLANES_PER_ENEMY_WIDTH = 3, -- how many CAS/TAC can enter a combat depending on enemy width there
	LAND_COMBAT_STR_ARMOR_ON_SOFT_DICE_SIZE = 6,   -- CWIC Vanilla 2->6, extra damage dice if our armor outclasses enemy
	...
	EXPERIENCE_COMBAT_FACTOR = 0.1,                -- CWIC Vanilla 0.25->0.1, Combat bonus units get from their experience. Default value is 0.25. Experience per unit level = -x, 0, x, 2x, 3x, level 2 being the "basic" level and always having 0% bonus.
	...
	BASE_CAPTURE_EQUIPMENT_RATIO = 0.05,			-- CWIC Vanilla 0.0->0.05, after a successful land combat, ratio of the equipments that are being captured/salvaged from enemy's lost equipment
...
NAir = {
	AIR_WING_FLIGHT_SPEED_MULT = 0.02,					-- CWIC Vanilla no modified, Global speed multiplier for airplanes (affects fe.transferring to another base)
	AIR_WING_MAX_STATS_ATTACK = 1000,					-- CWIC Vanilla 100->1000,Max stats
	AIR_WING_MAX_STATS_DEFENCE = 1000,                  -- CWIC Vanilla 100->1000
	AIR_WING_MAX_STATS_AGILITY = 1000,                  -- CWIC Vanilla 100->1000
	AIR_WING_MAX_STATS_SPEED = 10000,                   -- CWIC Vanilla 1500->10000
	AIR_WING_MAX_STATS_BOMBING = 1000,                  -- CWIC Vanilla 100->1000
	AIR_WING_MAX_SIZE = 1000, 							-- CWIC Vanilla no modified, Max amount of airplanes in wing
	AIR_WING_AVERAGE_SIZE = 100, 						-- Eyeballed average amount of airplanes in wing. Used when calculating air volunteer.
	AIR_WING_BOMB_DAMAGE_FACTOR = 2,					-- CWIC Vanilla no modified, Used to balance the damage done while bombing.
	BIGGEST_AGILITY_FACTOR_DIFF = 3.0,					-- CWIC Vanilla 3.0->2.5, biggest factor difference in agility for doing damage (caps to this)
	...
	COMBAT_DAMAGE_STATS_MULTILIER = 0.2,                -- CWIC Vanilla no modified
	COMBAT_BETTER_AGILITY_DAMAGE_REDUCTION = 0.6, 		-- CWIC Vanilla 0.30->0.6, How much the better agility (then opponent's) can reduce their damage to us.
	...
	COMBAT_MAX_WINGS_AT_ONCE = 10000, 				    -- CWIC Vanilla no modified, Max amount of air wings in one combat simulation. The higher value, the quicker countries may loose their wings. It's a gameplay balance value.
	COMBAT_MAX_WINGS_AT_GROUND_ATTACK = 10000,	        -- CWIC Vanilla no modified, we can really pounce a land strike and escalate
	COMBAT_MAX_WINGS_AT_ONCE_PORT_STRIKE = 10000,       -- CWIC Vanilla no modified, we can really pounce a naval strike and escalate
	AIR_REGION_SUPERIORITY_PIXEL_SCALE = 0.04,          -- CWIC Vanilla no modified, air superiority scale = superiority/(pixels*this)
	COMBAT_MULTIPLANE_CAP = 3.0,						-- CWIC Vanilla no modified, How many planes can shoot at each plane on other side ( if there are 100 planes we are atttacking COMBAT_MULTIPLANE_CAP * 100 of our planes can shoot )
	COMBAT_DAMAGE_SCALE = 0.2,							-- CWIC Vanilla 1->0.2, Higher value = more shot down planes
	...
	NAVAL_STRIKE_DAMAGE_TO_STR = 1.0,					-- CWIC Vanilla no modified, Balancing value to convert damage ( naval_strike_attack * hits ) to Strength reduction.
	NAVAL_STRIKE_DAMAGE_TO_ORG = 0.5,					-- CWIC Vanilla 1.5->0.5, Balancing value to convert damage ( naval_strike_attack * hits ) to Organisation reduction.
	...
	STRATEGIC_BOMBER_NUKE_AIR_SUPERIORITY = 10.0,		-- CWIC Vanilla 0.75->10.0, How much air superiority is needed for a tactical bomber to be able to nuke a province
	...
	NAVAL_COMBAT_EXTERNAL_PLANES_JOIN_RATIO = 0.02,		-- CWIC Vanilla 0.05->0.02, Max planes that can join a combat comparing to the total strength of the ships
	...
	MISSION_COMMAND_POWER_COSTS = {  -- command power cost per plane to create a mission
		...
		0.0, -- CWIC Vanilla 0.05->0.0, AIR_SUPPLY
		0.0, -- TRAINING
...
NNavy = {
	...
	NAVAL_INVASION_PREPARE_HOURS = 72,								-- CWIC Vanilla 168->72, base hours needed to prepare an invasion
	...
	CARRIER_STACK_PENALTY = 8,										-- CWIC Vanilla 4->8, The most efficient is 4 carriers in combat. 5+ brings the penalty to the amount of wings in battle.
	CARRIER_STACK_PENALTY_EFFECT = 0.1,								-- CWIC Vanilla 0.2->0.1, Each carrier above the optimal amount decreases the amount of airplanes being able to takeoff by such %.
	SHORE_BOMBARDMENT_CAP = 0.15,                                   -- CWIC Vanilla 0.25->0.15, Maximum shore bombardment
	...
	-- 注意，这些数值在CWIC Vanilla中没有明确指向，可能存在迁移错误
	MISSION_FUEL_COSTS = {  -- fuel cost for each mission
		1.0,  -- CWIC Vanilla 0.0->1.0, HOLD (consumes fuel HOLD_MISSION_MOVEMENT_COST fuel while moving)
		0.5,  -- CWIC Vanilla 1.0->0.5, PATROL
		0.2,  -- CWIC Vanilla 1.0->0.2, STRIKE FORCE (does not cost fuel at base, and uses IN_COMBAT_FUEL_COST in combat. this is just for the movement in between)
		1.3,  -- CWIC Vanilla 1.0->1.3, CONVOY RAIDING
		1.3,  -- CWIC Vanilla 1.0->1.3, CONVOY ESCORT
		20.0, -- CWIC Vanilla 1.0->20.0, MINES PLANTING
		3.0,  -- CWIC Vanilla 1.0->3.0, MINES SWEEPING
		1.0,  -- CWIC Vanilla 0.6->1.0, TRAIN
		1.3,  -- CWIC Vanilla 0.0->1.3, RESERVE_FLEET (consumes fuel HOLD_MISSION_MOVEMENT_COST fuel while moving)
		2.0,  -- CWIC Vanilla 1.0->2.0, NAVAL_INVASION_SUPPORT (does not cost fuel at base, only costs while doing bombardment and escorting units)
		0.5,  -- CWIC Vanilla
		2.0,  -- CWIC Vanilla
		2.0,  -- CWIC Vanilla
		1.0,  -- CWIC Vanilla
	...
	HEAVY_GUN_ATTACK_TO_SHORE_BOMBARDMENT							= 0.05,  -- CWIC Vanilla 0.1->0.05, heavy gun attack value is divided by this value * 100 and added to shore bombardment modifier
	LIGHT_GUN_ATTACK_TO_SHORE_BOMBARDMENT							= 0.15, -- CWIC Vanilla 0.05->0.15, light gun attack value is divided by this value * 100 and added to shore bombardment modifier
	...
	SUBMARINE_HIDE_TIMEOUT 											= 4,		-- CWIC Vanilla 20->4, Amount of in-game-hours that takes the submarine (with position unrevealed), to hide.
	SUBMARINE_REVEALED_TIMEOUT 										= 8,		-- CWIC Vanilla 16->8, Amount of in-game-hours that makes the submarine visible if it is on the defender side.
	SUBMARINE_REVEAL_BASE_CHANCE 									= 0.002,	-- CWIC Vanilla 11->0.002, Base factor for submarine detection. It's modified by the difference of a spotter's submarines detection vs submarine visibility. Use this variable for game balancing. setting this too low will cause bad spotting issues.
...
NTrade = {
	...
	RELATION_TRADE_FACTOR = 5,					-- CWIC Vanilla 1->5, Trade factor is modified by Opinion value times this
...
NAI = {
	...
	DIPLOMATIC_ACTION_BREAK_SCORE = -10, 		-- CWIC Vanilla no modified, AI must score a diplomatic action less than this to break it off
	DIPLOMACY_CREATE_FACTION_FACTOR = 0.0,		-- CWIC Vanilla 0.75->0.0, Factor for AI desire to create a new faction. Val < 1.0 makes it less likely to create than to join.
	DIPLOMACY_FACTION_WRONG_IDEOLOGY_PENALTY = 0, -- CWIC Vanilla 60->0, AI penalty for diplomatic faction acitons between nations of different ideologies
	DIPLOMACY_FACTION_SAME_IDEOLOGY_MAJOR = 0,  -- CWIC Vanilla 10->0 AI bonus acceptance when being asked about faction is a major of the same ideology
	...
	DIPLOMACY_FACTION_GLOBAL_TENSION_FACTOR = 0.0,-- CWIC Vanilla 0.2->0.0, How much the AI takes global tension into account when considering faction actions
	...
	DIPLOMACY_SCARED_MINOR_EXTRA_RELUCTANCE = -50, -- CWIC Vanilla no modified, extra reluctance to join stuff as scared minor
	DIPLOMACY_FACTION_PLAYER_JOIN = 20,			-- Bonus for human players asking to join a faction.
	DIPLOMACY_BOOST_PARTY_COST_FACTOR = 0.0,	-- CWIC Vanilla 100.0->0.0, Desire to boost party popularity subtracts the daily cost multiplied by this
	DIPLOMACY_IMPROVE_RELATION_COST_FACTOR = 0.0,-- CWIC Vanilla 5.0->0.0, Desire to boost relations subtracts the cost multiplied by this
	DIPLOMACY_IMPROVE_RELATION_PP_FACTOR = 0.1,	-- CWIC Vanilla 0.1->0.0, Desire to boost relations adds total PP multiplied by this
	...
	DIPLO_PREFER_OTHER_FACTION = -125,			-- CWIC Vanilla -200->-125 The country has yet to ask some other faction it would prefer to be a part of.
	...
	RESEARCH_LAND_DOCTRINE_NEED_GAIN_FACTOR = 0.1, -- CWIC Vanilla 0.15->0.1, Multiplies value based on relative military industry size / country size.
	RESEARCH_NAVAL_DOCTRINE_NEED_GAIN_FACTOR = 0.075, -- CWIC Vanilla 0.05->0.075, Multiplies value based on relative naval industry size / country size.
	RESEARCH_AIR_DOCTRINE_NEED_GAIN_FACTOR = 0.08, -- CWIC Vanilla 0.07->0.08, Multiplies value based on relative number of air base / country size.
	...
	RESEARCH_BONUS_FACTOR = 1.5, 				-- CWIC Vanilla 0.9->1.5, To which extent AI should care about bonuses to research
	MAX_AHEAD_RESEARCH_PENALTY = 0,             -- CWIC Vanilla 2->0, max ahead of tiem penalty ai will pick ever
	RESEARCH_AHEAD_OF_TIME_FACTOR = 10.0, 		-- CWIC Vanilla 4.0->10.0, To which extent AI should care about ahead of time penalties to research
	...
	ROCKET_MIN_ASSIGN_SCORE = 0,				-- CWIC Vanilla 10->0, Minimum total score for region to be considered for rocket air missions
	ROCKET_MIN_PRIO_ASSIGN_SCORE = 0,			-- CWIC Vanilla 50->0Minimum total score for region to be considered for critical rocket air missions
	ROCKET_ASSIGN_SCORE_REDUCTION_PER_ASSIGNMENT = 0, -- CWIC Vanilla 0.5->0, each assigned rocket reduces the score of a region by this amount
	...
	DEPLOY_MIN_EQUIPMENT_WAR_FACTOR = 0.75,		-- CWIC Vanilla 0.95->0.75 Required percentage of equipment (1.0 = 100%) for AI to deploy unit in wartime
	...
	NUM_SILOS_PER_CIVILIAN_FACTORIES = 0.2,						-- CWIC Vanilla 0.0025->0.2, ai will try to build a silo per this ratio of civ factories
...
NFocus = {
	FOCUS_POINT_DAYS = 5,						-- CWIC Vanilla 7->5, Each point takes a week
	FOCUS_PROGRESS_PEACE = 1,					-- Progress during peace
	FOCUS_PROGRESS_WAR = 1,						-- Progress during war
	MAX_SAVED_FOCUS_PROGRESS = 15,				-- CWIC Vanilla 10->15, This much progress can be saved while not having a focus selected
},

NOperatives = {
	AGENCY_CREATION_DAYS = 200,						-- CWIC Vanilla 30->200, Number of days needed to create an intelligence agency
	AGENCY_UPGRADE_DAYS = 100,						-- CWIC Vanilla 30->100, Number of days needed to upgrade an intelligence agency
	AGENCY_CREATION_FACTORIES = 15,					-- CWIC Vanilla 5->15, Number of factories used to create an intelligence agency
	...
	AGENCY_UPGRADE_PER_OPERATIVE_SLOT = 24,			-- CWIC Vanilla 5->24, Number of upgrade needed to unlock an additional operative slot
	MAX_OPERATIVE_SLOT_FROM_AGENCY_UPGRADES = 1,	-- max operative slots gained from upgrades
	AGENCY_OPERATIVE_RECRUITMENT_TIME = 90,			-- CWIC Vanilla 30->90, Number of days to wait to have operative to recruit when an operative slot first becomes available
	...
	MAX_RECRUITED_OPERATIVES = 25,                          -- CWIC Vanilla 10->25
